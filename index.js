...
const STORAGE_KEYS = {
  ...
  PRESIDENTS: 'leo_club_presidents_v5',
  CLUBS: 'leo_clubs_directory_v5',
...
const SEED_PRESIDENTS = [
  ...
  { id: 'pr-4', name: 'Leo Sasun Wijeratne', clubName: 'Leo Club of UOC Alumni', position: 'Club President', year: '2026/2027', region: 'Region B', phone: '+94 77 444 5555', email: 'sasun@uocalumnileos.org', facebook: '#', instagram: '#', linkedin: '#', bio: 'Reuniting graduates for sustainable development goals.', status: 'Active', displayOrder: 4, photo: null },
  { id: 'pr-5', name: 'Leo Sajeetharan Mahadevan', clubName: 'Leo Club of University of Colombo Faculty of Science', position: 'Club President', year: '2026/2027', region: 'Region B', phone: '+94 77 555 6666', email: 'sajeetharan@uocscienceleos.org', facebook: '#', instagram: '#', linkedin: '#', bio: 'Promoting science communication and science outreach programs.', status: 'Active', displayOrder: 5, photo: null },
  { id: 'pr-6', name: 'Leo Vimukthi Rukshika', clubName: 'Leo Club of University of Colombo Faculty of Arts', position: 'Club President', year: '2026/2027', region: 'Region B', phone: '+94 77 666 7777', email: 'vimukthi@uocartsleos.org', facebook: '#', instagram: '#', linkedin: '#', bio: 'Passionate about structural policy edits and community engagement.', status: 'Active', displayOrder: 6, photo: null },
  { id: 'pr-7', name: 'Leo Yoshani Madhurangi', clubName: 'Leo Club of UOC FOA Alumni', position: 'Club President', year: '2026/2027', region: 'Region B', phone: '+94 77 777 8888', email: 'yoshani@uocfoaalumnileos.org', facebook: '#', instagram: '#', linkedin: '#', bio: 'Coordinating large-scale alumni service operations.', status: 'Active', displayOrder: 7, photo: null },
  { id: 'pr-8', name: 'Leo Lion Sithuli Amunuthuduwa', clubName: 'Leo Club of Informatics Institute of Technology', position: 'Club President', year: '2026/2027', region: 'Region C', phone: '+94 77 888 9999', email: 'sithuli@iitleoclub.org', facebook: '#', instagram: '#', linkedin: '#', bio: 'Encouraging girls in STEM and tech service project creation.', status: 'Active', displayOrder: 8, photo: null },
  { id: 'pr-9', name: 'Leo Lion Nuran Nayanajith', clubName: 'Leo Club of Moratuwa', position: 'Club President', year: '2026/2027', region: 'Region C', phone: '+94 77 999 0000', email: 'nuran@moratuwaleos.org', facebook: '#', instagram: '#', linkedin: '#', bio: 'Passionate about water purification systems and rural development.', status: 'Active', displayOrder: 9, photo: null },
  { id: 'pr-10', name: 'Leo Senuja Kaluarachchi', clubName: 'Leo Club of Moratuwa Rathmalana', position: 'Club President', year: '2026/2027', region: 'Region C', phone: '+94 77 000 1111', email: 'senuja@moratuwarathmalanaleos.org', facebook: '#', instagram: '#', linkedin: '#', bio: 'Engaged in medical screening and public sanitation systems.', status: 'Active', displayOrder: 10, photo: null },
  { id: 'pr-11', name: 'Leo Lion Pumudu Ramuditha', clubName: 'Leo Club of Moratuwa 2020', position: 'Club President', year: '2026/2027', region: 'Region C', phone: '+94 77 111 3333', email: 'pumudu@moratuwa2020leos.org', facebook: '#', instagram: '#', linkedin: '#', bio: 'Committed to recycling operations and waste management campaigns.', status: 'Active', displayOrder: 11, photo: null },
  { id: 'pr-12', name: 'Leo Minindu Witharana', clubName: 'Leo Club of Mount Lavinia Orient Centennial', position: 'Club President', year: '2026/2027', region: 'Region D', phone: '+94 77 222 4444', email: 'minindu@mountlaviniaorientleos.org', facebook: '#', instagram: '#', linkedin: '#', bio: 'Focused on child education and health camps.', status: 'Active', displayOrder: 12, photo: null },
  { id: 'pr-13', name: 'Leo Lion Geemeth Bodiyabadu', clubName: 'Leo Club of Royal Achievers', position: 'Club President', year: '2026/2027', region: 'Region D', phone: '+94 77 333 5555', email: 'geemeth@royalachieversleos.org', facebook: '#', instagram: '#', linkedin: '#', bio: 'Coordinating vision screening camps and welfare distributions.', status: 'Active', displayOrder: 13, photo: null },
  { id: 'pr-14', name: 'Leo Mihin Senarathna', clubName: 'Leo Club of Kothalawala Defense University', position: 'Club President', year: '2026/2027', region: 'Region D', phone: '+94 77 444 6666', email: 'mihin@kduleoclub.org', facebook: '#', instagram: '#', linkedin: '#', bio: 'Focused on disaster response drills and physical wellness campaigns.', status: 'Active', displayOrder: 14, photo: null },
  { id: 'pr-15', name: 'Leo Randidu Jayawardena', clubName: 'Leo Club of Prince of Wales', position: 'Club President', year: '2026/2027', region: 'Region E', phone: '+94 77 555 7777', email: 'randidu@princeofwalesleos.org', facebook: '#', instagram: '#', linkedin: '#', bio: 'Organizing school support drives and sports training courses.', status: 'Active', displayOrder: 15, photo: null },
  { id: 'pr-16', name: 'Leo Vinuri Aponso', clubName: 'Leo Club of Princess of Wales', position: 'Club President', year: '2026/2027', region: 'Region E', phone: '+94 77 666 8888', email: 'vinuri@princessofwalesleos.org', facebook: '#', instagram: '#', linkedin: '#', bio: 'Organizing child care camps and medical tests.', status: 'Active', displayOrder: 16, photo: null },
  { id: 'pr-17', name: 'Leo Danidu Damsith', clubName: 'Leo Club of Sri Sumangala College', position: 'Club President', year: '2026/2027', region: 'Region E', phone: '+94 77 777 9999', email: 'danidu@srisumangalaleos.org', facebook: '#', instagram: '#', linkedin: '#', bio: 'Coordinating village support projects and welfare events.', status: 'Active', displayOrder: 17, photo: null },
  { id: 'pr-18', name: 'Leo Ometh Nethsanda', clubName: 'Leo Club of Kalutara Vidyalaya', position: 'Club President', year: '2026/2027', region: 'Region E', phone: '+94 77 888 0000', email: 'ometh@kalutaravidyalayaleos.org', facebook: '#', instagram: '#', linkedin: '#', bio: 'Committed to green initiatives and emergency relief operations.', status: 'Active', displayOrder: 18, photo: null },
  { id: 'pr-19', name: 'Leo Sethmi Sonaya', clubName: 'Leo Club of Kalutara Balika Vidyalaya', position: 'Club President', year: '2026/2027', region: 'Region E', phone: '+94 77 999 1111', email: 'sethmi@kalutarabalikaleos.org', facebook: '#', instagram: '#', linkedin: '#', bio: 'Committed to child development and village support camps.', status: 'Active', displayOrder: 19, photo: null }
];
